...
//		patientLogInPage.getPatientUserNameTextField().sendKeys("mani@outlook.com");
//		patientLogInPage.getPatientPasswordTextfield().sendKeys("Mani@123");
...
//		doctorHomePage.getLogOutButton().click();
////		driver.findElement(By.xpath("//li[@class='dropdown current-user']")).click();
////		driver.findElement(By.xpath("//a[contains(.,'Log Out')]")).click();
//
//		// Check whether home page is displayed or not?
