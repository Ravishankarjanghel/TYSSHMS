...
public class DoctorVarification extends BaseClass{

	@Test(groups = "regTest")
	public void doctorVarification() throws EncryptedDocumentException, IOException {
		...
		Assert.assertTrue(editDocPage.contains("Hospital_Management_System/hms/doctor/edit-profile"), "Edit doctor page is not displayed.");
